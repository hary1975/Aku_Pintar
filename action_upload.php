...
$file_type	= array('pdf','jpg','jpeg','png','gif','bmp','doc','docx','xls','xlsx','sql');
...
if(isset($_POST['btnUpload'])){
	...
	if($eror == true){
		...
		if(move_uploaded_file($_FILES['data_upload']['tmp_name'], $folder.$file_name)){
			...
			$catat = mysql_query('insert into file_upload(nis,pass,Filename,Detail,Folder,DateUpload) values ("'.$_POST['nis'].'","'.$ps.'","'.$file_name.'", "'.$_POST['keterangan'].'", 
